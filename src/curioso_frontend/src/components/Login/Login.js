...
const Login = ({pending, handleSearch, tasks, setPending}) => {
  ...
  return (
    <div className="flex items-center justify-center absolute gap-10 flex-wrap mt-28 md:mt-0 bg-slate-200 w-full h-full -z-10 mb-20">
      ...
      <div className="py-2 px-4 flex justify-center items-center rounded-3xl border-[6px] border-slate-200 shadow-home">
      <ConnectButton dark={false}
      onConnect={() => { connected }}
      onDisconnect={() => { disconnected }} />
      </div>
      </div>
      <div className="w-[340px] h-[400px] md:ml-16 flex flex-col overflow-y-auto pt-8 items-center justify-center">
